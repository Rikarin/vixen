...
[DataSerializerGlobal(
    ...
    typeof(Collections.SortedList<,>),
    DataSerializerGenericMode.GenericArguments
)]
public class SortedListSerializer<TKey, TValue> : DataSerializer<Collections.SortedList<TKey, TValue>>,
    ...
    public override void PreSerialize(
        ref Collections.SortedList<TKey, TValue> obj,
        ArchiveMode mode,
        ...
        if (mode == ArchiveMode.Deserialize) {
            ...
            if (obj == null) {
                obj = new Collections.SortedList<TKey, TValue>();
            } else {
                obj.Clear();
            }
        }
