...
/// <summary>
///     Declares a serializer like <see cref="DataSerializerAttribute" /> or <see cref="DataContractAttribute" />, but
///     externally.
/// </summary>
...
public class DataSerializerGlobalAttribute : Attribute {
    ...
    ///     either by its serializer type (it will act like <see cref="DataSerializerAttribute" /> and guess data type from the
    ///     generic type of <see cref="DataSerializer{T}" />) or the data type (it will act just like if
    ///     <see cref="DataContractAttribute" /> was set on the data type).
    /// </summary>
