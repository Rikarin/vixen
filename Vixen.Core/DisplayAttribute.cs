...
public class DisplayAttribute : Attribute {
    static readonly Dictionary<MemberInfo, DisplayAttribute> RegisteredDisplayAttributes = new();
    ...
    public DisplayAttribute(int order, string? name = null, string? category = null) : this(name, category) {
        Order = order;
    }
    ...
    /// <summary>
    ///     Gets the display name of the given type. The display name is the name of the type, or, if the
    ///     <see cref="DisplayAttribute" /> is
