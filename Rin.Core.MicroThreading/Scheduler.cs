...
public class Scheduler {
    ...
    ///     true.
    ///     This can be overridden to false per <see cref="MicroThread" /> by using
    ///     <see cref="MicroThreadFlags.IgnoreExceptions" />.
    /// </summary>
    /// <value>
    ...
    internal PriorityQueueNode<SchedulerEntry> Add(
        Action simpleAction,
        int priority = 0,
        object? token = null,
        ProfilingKey? profilingKey = null
    ) {
        var schedulerEntryNode = new PriorityQueueNode<SchedulerEntry>(
