...
public struct GamePadState : IEquatable<GamePadState> {
    ...
    /// </summary>
    public GamePadButton Buttons { get; internal set; }
    ...
    public override int GetHashCode() {
        unchecked {
            var hashCode = Buttons.GetHashCode();
    ...
    public override string ToString() =>
        $"Buttons: {Buttons}, LeftThumb: {LeftThumb}, RightThumb: {RightThumb}, LeftTrigger: {LeftTrigger}, RightTrigger: {RightTrigger}";
    ...
    bool UpdateFloat(ref float a, GamePadAxisEvent evt) {
