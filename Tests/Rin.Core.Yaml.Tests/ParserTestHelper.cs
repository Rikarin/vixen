...
using AnchorAlias = Rin.Core.Yaml.Events.AnchorAlias;
using DocumentEnd = Rin.Core.Yaml.Events.DocumentEnd;
using DocumentStart = Rin.Core.Yaml.Events.DocumentStart;
using Scalar = Rin.Core.Yaml.Events.Scalar;
using StreamEnd = Rin.Core.Yaml.Events.StreamEnd;
using StreamStart = Rin.Core.Yaml.Events.StreamStart;
