...
namespace Vixen.Core.Design.Tests;

public class UPath_Test {
    [Fact]
    ...
    public void TestUPathIsRelativeAndIsAbsolute() {
        var assert = new Action<UPath, bool>(
            (x, isAbsolute) => {
    ...
    public void TestUPathGetFullDirectory() {
        Assert.Equal(new("/a"), new UFile("/a/b.txt").GetFullDirectory());
        Assert.Equal(new("/a/b"), new UFile("/a/b/c.txt").GetFullDirectory());
        Assert.Equal(new("/a/b"), new UFile("/a/b/c").GetFullDirectory());
        Assert.Equal(new("/"), new UFile("/a.txt").GetFullDirectory());
        Assert.Equal(new("E:/"), new UFile("E:/a.txt").GetFullDirectory());
        Assert.Equal(new("E:/a"), new UFile("E:/a/b.txt").GetFullDirectory());
        Assert.Equal(new("E:/a/b"), new UFile("E:/a/b/c.txt").GetFullDirectory());
        Assert.Equal(new("E:/a/b"), new UFile("E:/a/b/c").GetFullDirectory());
        Assert.Equal(new("/a/b/c"), new UDirectory("/a/b/c").GetFullDirectory());
        Assert.Equal(new("E:/a/b/c"), new UDirectory("E:/a/b/c").GetFullDirectory());
        Assert.Equal(new("/a"), new UDirectory("/a").GetFullDirectory());
        Assert.Equal(new("E:/a"), new UDirectory("E:/a").GetFullDirectory());
        Assert.Equal(new("/"), new UDirectory("/").GetFullDirectory());
        Assert.Equal(new("E:/"), new UDirectory("E:/").GetFullDirectory());
        Assert.Equal(new("E:/"), new UDirectory("E:").GetFullDirectory());
        Assert.Equal(new("E:"), new UDirectory("E:/").GetFullDirectory());
        Assert.Equal(new("E:"), new UDirectory("E:").GetFullDirectory());
        Assert.Equal(new(null), new UFile("a.txt").GetFullDirectory());
        Assert.Equal(new(null), new UFile("").GetFullDirectory());
    ...
    public void TestUPathCombine() {
        ...
        Assert.Equal(new("e.txt"), UPath.Combine(".", new UFile("e.txt")));
        Assert.Equal(new("/a/b/d/e.txt"), UPath.Combine("/a/b/c", new UFile("../d/e.txt")));
        Assert.Equal(new("/d/e.txt"), UPath.Combine("/a/b/c", new UFile("../../../d/e.txt")));
        Assert.Equal(new("/d/e.txt"), UPath.Combine("/a/b/c", new UFile("../../../../../../d/e.txt")));
        Assert.Equal(new("C:/a/d/e.txt"), UPath.Combine("C:/a/b/c", new UFile("../../d/e.txt")));
        Assert.Equal(new("C:/d/e.txt"), UPath.Combine("C:/a/b/c", new UFile("../../../d/e.txt")));
        Assert.Equal(new("C:/d/e.txt"), UPath.Combine("C:/a/b/c", new UFile("../../../../../../d/e.txt")));
        Assert.Equal(new("C:/a.txt"), UPath.Combine("C:/", new UFile("a.txt")));
        Assert.Equal(new("C:/a/b.txt"), UPath.Combine("C:/a", new UFile("b.txt")));
        Assert.Equal(new("C:/a.txt"), UPath.Combine("C:/", new UFile("./a.txt")));
        Assert.Equal(new("C:/a/b.txt"), UPath.Combine("C:/a", new UFile("./b.txt")));
        Assert.Equal(new("C:/a.txt"), UPath.Combine("C:/", new UFile("././a.txt")));
        Assert.Equal(new("C:/a/b.txt"), UPath.Combine("C:/a", new UFile("././b.txt")));
