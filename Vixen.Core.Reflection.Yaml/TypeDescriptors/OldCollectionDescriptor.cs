...
public class OldCollectionDescriptor : CollectionDescriptor {
    ...
    readonly Func<object, int> GetCollectionCountFunction;
    readonly Func<object, int, object> GetIndexedItem;
    readonly Action<object, int, object> SetIndexedItem;
    readonly Action<object, object> CollectionAddFunction;
    readonly Action<object, int, object> CollectionInsertFunction;
    readonly Action<object, int> CollectionRemoveAtFunction;
    readonly Action<object, object> CollectionRemoveFunction;
    readonly Action<object> CollectionClearFunction;
    ...
    public OldCollectionDescriptor(
    ...
    public override bool IsReadOnly(object collection) =>
        collection == null || IsReadOnlyFunction == null || IsReadOnlyFunction(collection);
    ...
    public override int GetCollectionCount(object collection) =>
        collection == null || GetCollectionCountFunction == null ? -1 : GetCollectionCountFunction(collection);
