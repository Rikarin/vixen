...
public interface IYamlSchema {
    ...
    /// <summary>
    ///     Gets the default tag for the specified <see cref="NodeEvent" />. The default tag can be different from a actual tag
    ///     of this <see cref="NodeEvent" />.
    /// </summary>
    ...
    /// <summary>
    ///     Gets the default tag for the specified <see cref="Type" />. This is only valid for scalar, return null if no
    ///     default tag found.
    /// </summary>
    /// <returns>A short tag.</returns>
