...
public class ListSerializer<T> : DataSerializer<List<T>>, IDataSerializerGenericInstantiation {
    DataSerializer<T> itemDataSerializer;
    ...
    /// <inheritdoc />
    public void EnumerateGenericInstantiations(
        SerializerSelector serializerSelector,
        IList<Type> genericInstantiations
    ) {
...
public class ListAllSerializer<TList, T> : DataSerializer<TList>, IDataSerializerGenericInstantiation
    where TList : class, IList<T> {
    readonly bool isInterface = typeof(TList).GetTypeInfo().IsInterface;
    DataSerializer<T> itemDataSerializer;
...
[DataSerializerGlobal(
    typeof(SortedListSerializer<,>),
    typeof(Rin.Core.Collections.SortedList<,>),
    DataSerializerGenericMode.GenericArguments
)]
public class SortedListSerializer<TKey, TValue> : DataSerializer<Rin.Core.Collections.SortedList<TKey, TValue>>,
    IDataSerializerGenericInstantiation {
    DataSerializer<TKey> keySerializer;
    DataSerializer<TValue> valueSerializer;
    ...
    public override void PreSerialize(
        ref Rin.Core.Collections.SortedList<TKey, TValue> obj,
        ArchiveMode mode,
        ...
        if (mode == ArchiveMode.Deserialize) {
            ...
            if (obj == null) {
                obj = new Rin.Core.Collections.SortedList<TKey, TValue>();
            } else {
                obj.Clear();
            }
        }
...
public class BlittableArraySerializer<T> : ArraySerializer<T> where T : unmanaged {
    ...
    /// <inheritdoc />
    public override void Serialize(ref T[]? array, ArchiveMode mode, SerializationStream stream) {
...
public class KeyValuePairSerializer<TKey, TValue> : DataSerializer<KeyValuePair<TKey, TValue>>,
    IDataSerializerGenericInstantiation {
    DataSerializer<TKey> keySerializer;
    DataSerializer<TValue> valueSerializer;
...
public class DictionarySerializer<TKey, TValue> : DataSerializer<Dictionary<TKey, TValue>>,
    IDataSerializerGenericInstantiation {
    DataSerializer<TKey> keySerializer;
    DataSerializer<TValue> valueSerializer;
...
public class DictionaryAllSerializer<TDictionary, TKey, TValue> : DataSerializer<TDictionary>,
    IDataSerializerGenericInstantiation where TDictionary : IDictionary<TKey, TValue> {
    readonly bool isInterface = typeof(TDictionary).GetTypeInfo().IsInterface;
    DataSerializer<TKey> keySerializer;
    DataSerializer<TValue> valueSerializer;
    ...
    public override void PreSerialize(ref TDictionary? obj, ArchiveMode mode, SerializationStream stream) {
        if (mode == ArchiveMode.Deserialize) {
            ...
            if (obj == null) {
                obj = isInterface
                    ? (TDictionary)(object)new Dictionary<TKey, TValue>()
...
[DataSerializerGlobal(
    typeof(DictionaryInterfaceSerializer<,>),
    typeof(IDictionary<,>),
    DataSerializerGenericMode.GenericArguments
)]
public class DictionaryInterfaceSerializer<TKey, TValue> : DataSerializer<IDictionary<TKey, TValue>>,
    IDataSerializerGenericInstantiation {
    DataSerializer<TKey> keySerializer;
    DataSerializer<TValue> valueSerializer;
