...
using AnchorAlias = Vixen.Core.Yaml.Tokens.AnchorAlias;
using DocumentEnd = Vixen.Core.Yaml.Tokens.DocumentEnd;
using DocumentStart = Vixen.Core.Yaml.Tokens.DocumentStart;
using Event = Vixen.Core.Yaml.Events.ParsingEvent;
using Scalar = Vixen.Core.Yaml.Tokens.Scalar;
using StreamEnd = Vixen.Core.Yaml.Tokens.StreamEnd;
using StreamStart = Vixen.Core.Yaml.Tokens.StreamStart;
