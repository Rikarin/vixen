...
public interface ISerializerFactorySelector {
    /// <summary>
    ///     Tries to register the given factory to this selector. The factory might be ignored if it doesn't match the criteria
    ///     of the selector.
    /// </summary>
    ...
    /// <summary>
    ///     Seals the selector. No factory can be added to the selector after it has been sealed. The selector cannot be used
    ///     to retrieve serializers until it's sealed.
    /// </summary>
    void Seal();
