...
public enum Key {
    ...
    /// <summary>
    ///     The 'OemPipe'/'oem5' key, either at the lower left of the 'return' key for ISO or between 'return' and 'backspace'
    ///     for ANSI on a standard US layout.
    /// </summary>
    Oem5 = OemPipe,
    ...
    /// <summary>
    ///     The 'oem8' key, on a UK layout the left most key on the number row, same position as <see cref="OemTilde" /> on US
    ///     layout.
    /// </summary>
    Oem8 = 153,
