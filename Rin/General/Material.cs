...
public class Material {
    ...
    public void SetTexture(string name, Texture value) {
        nameBuffer[name] = new(MaterialType.Texture, value, () => Shader.Handle.SetTexture(name, value));
    }

    public void SetTexture(int id, Texture value) {
        idBuffer[id] = new(MaterialType.Texture, value, () => Shader.Handle.SetTexture(id, value));
    }

    public void SetTexture(string name, RenderTexture value) {
        nameBuffer[name] = new(MaterialType.RenderTexture, value, () => Shader.Handle.SetTexture(name, value));
    }

    public void SetTexture(int id, RenderTexture value) {
        idBuffer[id] = new(MaterialType.RenderTexture, value, () => Shader.Handle.SetTexture(id, value));
    }
